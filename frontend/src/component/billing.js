                    ...
                    <div className='col-lg-12'>
                        <Container>
                            <div style={{
                                ...
                                <Card>
                                    <CardHeader style={{ marginBottom: '-2.5vh' }} title="Billing" />
                                            ...
                                            <Table>
                                                <TableHead className="bg-primary">
                                                    <TableRow>
                                                        ...
                                                        <TableCell sx={{ whiteSpace: 'nowrap', fontWeight: 'bold', color: 'white' }}>Status</TableCell>
                                                ...
                                                <TableBody>
                                                    {data.map((data, i) => (
                                                        <TableRow key={i}>
                                                            ...
                                                            <TableCell><button type='btn' className='btn' style={{backgroundColor:'#e1ffdc'}}>Paid</button></TableCell>
                                                        </TableRow>
                                                    ))}
